...
* `diamond_nv_gpaw_ae`: calculation of the ZFS tensor for the negatively-charged nitrogen-vacancy center in diamond using GPAW, with all electron wave function reconstruction.
* `c3h6_gpaw`: calculation of the ZFS tensor for the C3H6 biradical using GPAW.
* `c3h6_gpaw_ae`: calculation of the ZFS tensor for the C3H6 biradical using GPAW, with all electron wave function reconstruction.
